...
public final class ActivitySettinsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView closeSettingsBtn;
  ...
  private ActivitySettinsBinding(@NonNull RelativeLayout rootView,
      @NonNull AppBarLayout appBarSettings, @NonNull Button btnLocation,
      @NonNull TextView closeSettingsBtn, @NonNull TextView profileImageChangeBtn,
      @NonNull Button securityQuestionsBtn, @NonNull EditText settingsAddress,
    ...
    this.closeSettingsBtn = closeSettingsBtn;
  ...
  public static ActivitySettinsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.close_settings_btn;
      TextView closeSettingsBtn = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivitySettinsBinding((RelativeLayout) rootView, appBarSettings, btnLocation,
          closeSettingsBtn, profileImageChangeBtn, securityQuestionsBtn, settingsAddress,
          settingsFullName, settingsPhoneNumber, settingsProfileImage, toolbarSettings,
