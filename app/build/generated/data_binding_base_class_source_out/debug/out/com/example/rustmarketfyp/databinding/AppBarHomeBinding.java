...
public final class AppBarHomeBinding implements ViewBinding {
  ...
  private AppBarHomeBinding(@NonNull CoordinatorLayout rootView, @NonNull FloatingActionButton fab,
      @NonNull Button searchBtn, @NonNull EditText searchProductName, @NonNull Toolbar toolbar) {
  ...
  public static AppBarHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppBarHomeBinding((CoordinatorLayout) rootView, fab, searchBtn, searchProductName,
          toolbar);
    }
