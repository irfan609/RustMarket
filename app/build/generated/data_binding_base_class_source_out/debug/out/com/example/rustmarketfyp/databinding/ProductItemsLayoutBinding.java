...
public final class ProductItemsLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView productCondition;
  ...
  private ProductItemsLayoutBinding(@NonNull CardView rootView, @NonNull TextView productCondition,
  ...
  public static ProductItemsLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView productCondition = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ProductItemsLayoutBinding((CardView) rootView, productCondition,
          productDescription, productImage, productLocation, productName, productPrice);
    }
